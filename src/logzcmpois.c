...
R_INLINE double comlogSumtransform(double mu, double nu, double normaliser, double start, int up, double log_pmf_prec, double sub_prec, int max_iter, int reset_cycle, logZ_register_t* reg, double* end) {
